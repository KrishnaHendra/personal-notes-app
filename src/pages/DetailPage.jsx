      ...
      return (
        <section className='detail-page'>
          <div className='error-message'>
            ...
            <p>Note with ID "{this.props.id}" is not available.</p>
          </div>
        </section>
      );
    }
    ...
    return (
      <section>
        ...
        <div className='detail-page__action'>
          <ButtonAction title='Edit' onClick={this.props.onEditButtonHandler} icon={<FiEdit2 />} />
          <ButtonAction
          ...
          />
          <ButtonAction title='Delete' onClick={this.onClickDeleteButton} icon={<FiTrash2 />} />
        </div>
      </section>
    );
  }
